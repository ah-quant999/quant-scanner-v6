...
| `dist/data/.deploy_alert.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/.fetch_errors.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/.fetch_log.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/.ops_status.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/.pre_market_failover.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/52w_high.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/_crisis_hist_cache.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/analyst_ratings.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/audit_summary.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/backtest_comprehensive.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/backtest_tdx.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/candidate_pool.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/capital_flow_summary.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/cffex_holdings.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/close_summary.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/cockpit_advice.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/cockpit_backtest.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/cockpit_tier_recommend.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/cockpit_tier_recommend_alimi.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/concept_history.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/concept_map.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/concept_ranking.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/crds_result.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/crisis_data.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/dxy_hist.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/etf_subscription.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/fomc_summary.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/fundamental_quality.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/gold_pool.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/guanlan_reports.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/guanlan_watchlist.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/hb_alimi.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/hb_cloud.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/hb_xiaojiu.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/herding_data.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/industry_map.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/industry_map_shard_1.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/industry_map_shard_2.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/industry_map_shard_3.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/industry_map_shard_4.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/industry_map_shard_5.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/industry_map_shard_6.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/inst_trade.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/ipo_score.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/lhb_history.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/lhb_result.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/limit_up_heatmap.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/lottery_data.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/macro_data.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/main_stock.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/main_week.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/margin_data.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/market_alerts.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/market_fund_flow.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/north_fund.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/nt_data.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/overnight_timeline.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/policy_density.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/recommend.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/scan_progress.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/scan_result.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/sector_fund_flow.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/sector_fund_flow_history.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/sector_fund_flow_westock.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/sector_rs.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/sh_index_fib.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/sh_sz_history.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/signal_backtest.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/stock_deviation.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/stock_names.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/suspension_alert.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/sz_index_fib.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/top10_daily.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/triple_consensus.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/usdcnh_hist.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/verify_report.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/watch_result.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
| `dist/data/zhaixingge_reports.json` | 主站数据副本 | 主站运行所需数据 | 自动同步 |
