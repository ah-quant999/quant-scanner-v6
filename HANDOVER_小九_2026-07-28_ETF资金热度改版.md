...
> ⚠️ **协调说明（2026-07-28 18:00 小九补）**：主人同日 17:42 已启动 **v8.0 改版**，v8 设计稿（`v8-prototype/design_v3_unified.html`）也含「ETF资金热度」卡。
> **v6 与 v8 是两条独立并行的线，互不等待、互不替代：**
> - 本任务（v6 ETF 资金热度方案C）是 **v6 生产站**的站内增强，必须按本交接独立完成、照常部署上线，不因 v8 推进而作废。
> - v8 是主人另起的改版线，阿狸咪按 v8 交接迭代 `v8-prototype/`，与 v6 互不干扰。
